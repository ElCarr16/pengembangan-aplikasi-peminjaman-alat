                ...
                <div class="card-body">
                    <form action="{{ route('admin.tools.update', $tool->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="form-select @error('category_id') isinvalid @enderror"
                                required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="stok" class="form-control @error('stok') isinvalid @enderror"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mt-2">
                                    ...
                                    <img src="{{ asset('storage/' . $tool->gambar) }}" alt="CurrentImage" class="img-thumbnail" style="height: 80px;">
                                </div>
                                @endif
                            </div>
                        </div>
