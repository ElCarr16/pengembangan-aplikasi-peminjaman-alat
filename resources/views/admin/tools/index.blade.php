            ...
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($tool->gambar)
                            <img src="{{ asset('storage/' . $tool->gambar) }}" alt="img" class="imgthumbnail"
                                style="height: 60px;">
                            @else
                        ...
                        <td>
                            <a href="{{ route('admin.tools.edit', $tool->id) }}" class="btn btn-warning btnsm">
                                Edit
                            </a>
                            <form action="{{ route('admin.tools.destroy', $tool->id) }}" method="POST" class="d-inline"
                                onsubmit="return confirm('Yakin ingin menghapus alat ini? Data peminjaman terkait mungkin akan error.');">
                                @csrf
                                @method('DELETE')
