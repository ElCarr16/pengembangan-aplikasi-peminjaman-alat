    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card text-white bg-primary mb-3 h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('users.index') }}" class="text-white text-decoration-none small">Lihat Detail &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-success mb-3 h-100">
                ...
                <div class="card-footer text-white">
                    <a href="{{ route('tools.index') }}" class="text-white text-decoration-none small">Lihat Detail &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-warning mb-3 h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('categories.index') }}" class="text-dark text-decoration-none small">Lihat Detail &rarr;</a>
                </div>
            </div>
        </div>
    </div>

    <!-- Baris Kedua: Status Transaksi -->
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="card text-white bg-danger mb-3 h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.loans.index') }}" class="text-white text-decoration-none small">Pantau &rarr;</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card text-white bg-info mb-3 h-100">
                ...
                <div class="card-footer">
                    <a href="{{ route('admin.returns.index') }}" class="text-white text-decoration-none small">Pantau &rarr;</a>
                </div>
            </div>
        </div>
    </div>

    <!-- Baris Ketiga: Log Aktivitas -->
    <div class="row">
        <div class="col-md-12">
