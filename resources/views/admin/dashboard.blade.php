        ...
        <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-success mb-3 h-100">
                        <div class="card-header">Data Alat</div>
                            <div class="card-body">
                                <h2 class="card-title">{{ $totalAlat }} <span class="fs-6">(Stok: {{ $totalStok }})</span>
                                </h2>
                ...
                <div class="col-md-4">
                    <div class="card text-white bg-warning mb-3 h-100">
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <a href="{{ route('categories.index') }}" class="text-dark text-decoration-none small">Lihat
                                Detail</a>
                    ...
                    <div class="card text-white bg-info mb-3 h-100">
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <a href="{{ route('admin.returns.index') }}"
                                class="text-white text-decoration-none small">Pantau</a>
                            <span class="small">&rarr;</span>
                        </div>
                    </div>
                </div>
