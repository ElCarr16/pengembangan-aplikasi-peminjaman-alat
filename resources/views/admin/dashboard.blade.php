...
<div class="row mb-4"> 
    <div class="col-md-4"> 
        <div class="card text-white bg-primary mb-3 h-100"> 
            ...
            <div class="card-footer d-flex justify-content-between align-items-center"> 
                <a href="{{ route('admin.users.index') }}" class="text-white text-decoration-none small">Lihat Detail</a> 
    ...
    <div class="col-md-4"> 
        <div class="card text-white bg-success mb-3 h-100"> 
            ...
            <div class="card-footer d-flex justify-content-between align-items-center"> 
                <a href="{{ route('admin.tools.index') }}" class="text-white text-decoration-none small">Lihat Detail</a> 
    ...
    <div class="col-md-4"> 
        <div class="card text-white bg-warning mb-3 h-100"> 
            ...
            <div class="card-footer d-flex justify-content-between align-items-center"> 
                <a href="{{ route('admin.categories.index') }}" class="text-dark text-decoration-none small">Lihat Detail</a> 
