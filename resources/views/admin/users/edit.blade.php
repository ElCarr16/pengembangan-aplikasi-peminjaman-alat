                        ...
                        <div id="peminjamFields" style="display: none;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" name="tanggal_lahir"
                                            ...
                                            id="tanggalLahir" value="{{ old('tanggal_lahir', $user->tanggal_lahir) }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" name="nomor_telepon"
                                            ...
                                            id="nomorTelepon" placeholder="08..."
                            ...
                            <div class="form-floating mb-3">
                                <textarea name="alamat" class="form-control rounded-3 @error('alamat') is-invalid @enderror" id="alamat"
                                    placeholder="Alamat Lengkap" style="height: 100px">{{ old('alamat', $user->alamat) }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating">
                                        <input type="text" name="kota"
                                            ...
                                            id="kota" placeholder="Kota" value="{{ old('kota', $user->kota) }}">
